...
simple 4-step recipe consisting of modeling a causal mode, identification, estimation, and refutation:
...
No idea what this means? Then the best place to learn more about this is the user guide's :doc:`.
./user_guide/effect_inference/index` chapter. Alternatively, learn about its basic features in
:doc:`../example_notebooks/dowhy_simple_example`.
